...
class SCAREd:
    ...
    def evaluation(self):
        ...
        if True:
            if not PERFECTED:
                det_right = 0
                out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/scared/" + task_name[:-1] + "/onlyED_" + task_name + check_string(dirty_path.split("/")[-1]) + ".txt"
                f = open(out_path, 'w')
                sys.stdout = f
                end_time = time.time()
                ...
                out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/scared/" + task_name[:-1] + "/oriED+EC_" + task_name + check_string(dirty_path.split("/")[-1]) + ".txt"
                res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Repaired_res/scared/" + task_name[:-1] + "/repaired_" + task_name + check_string(dirty_path.split("/")[-1]) + ".csv"
                ...
                out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/scared/" + task_name[:-1] + "/perfectED+EC_" + task_name + check_string(dirty_path.split("/")[-1]) + ".txt"
                res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Repaired_res/scared/" + task_name[:-1] + "/perfect_repaired_" + task_name + check_string(dirty_path.split("/")[-1]) + ".csv"
                self.rep_csv.to_csv(res_path, index=False, columns=list(self.rep_csv.columns))
                f = open(out_path, 'w')
                sys.stdout = f
                end_time = time.time()
...
if __name__ == "__main__": 
    ...
    try:
        ...
        # dirty_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/hospital/noise/hospital-inner_outer_error-10.csv"
        # rule_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/dc_rules-validate-fd-horizon.txt"
        ...
        if not PERFECTED:
            stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + 'scared'+task_name+check_string(dirty_path)
            ...
            if os.path.exists(stra_path):
                shutil.rmtree(stra_path)
            stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + 'scared'+task_name+check_string(dirty_path)
            if os.path.exists(stra_path):
                shutil.rmtree(stra_path)
            stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + 'scared'+task_name+check_string(dirty_path)
            if os.path.exists(stra_path):
