...
if __name__ == "__main__":
    ...
    res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/raha_baran/" + task_name[:-1] + "/raha_only_" + task_name + dirty_path[-25:-4] + ".txt"
    dataset_dictionary = {
        "name": dataset_name,
        "path": dirty_path,
