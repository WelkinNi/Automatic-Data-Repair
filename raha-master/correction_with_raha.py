...
if __name__ == "__main__":
    ...
    # dirty_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/tax-dirty-original_error-0001k.csv"

    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References/DATASET/data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
    ...
    try:
        ...
        out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/raha_baran/" + task_name[:-1] + "/onlyED_" + task_name + check_string(dirty_path) + ".txt"
        f = open(out_path, 'w')
        sys.stdout = f
        print("{}\n{}\n{}".format(p, r, f))
        ...
        out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/raha_baran/" + task_name[:-1] + "/oriED+EC_" + task_name + check_string(dirty_path) + ".txt"
        res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Repaired_res/raha_baran/" + task_name[:-1] + "/repaired_" + task_name + check_string(dirty_path) + ".csv"
        ...
        out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/raha_baran/" + task_name[:-1] + "/all_compute_" + task_name + check_string(dirty_path) + ".txt"
        f = open(out_path, 'w')
        sys.stdout = f
