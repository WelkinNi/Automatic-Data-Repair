...
if __name__ == "__main__":
    ...
    for data in dataset_name:
        dataset_dictionary = {
            "name": data,
            "path": f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{data}/noise/{data}-inner_outer_error-01.csv",
            "clean_path": f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{data}/clean.csv"
        }
        app = Baselines()
