...
if __name__ == "__main__":
    ...
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References/DATASET/data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/tax/split_data/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
    ...
    out_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Exp_result/raha_baran/" + task_name[:-1] + "/perfectED+EC_" + task_name + dirty_path[-25:-4] + ".txt"
    res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Repaired_res/raha_baran/" + task_name[:-1] + "/perfect_repaired_" + task_name + dirty_path[-25:-4] + ".csv"
