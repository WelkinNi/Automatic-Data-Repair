...
if __name__ == "__main__":
    ...
    stra_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/" + task_name[:-5] + "/noise/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    dataset_name = task_name
    res_path = "/data/nw/DC_ED/References_inner_and_outer/DATASET/Repaired_res/mode_repair/" + task_name[:-5] + "/repaired_" + task_name + dirty_path[-25:-4] + ".csv"
    dataset_dictionary = {
        "name": dataset_name,
        "path": dirty_path,
