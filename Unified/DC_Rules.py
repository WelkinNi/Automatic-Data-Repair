    ...
    def parser(self):
        ...
        if opt_idx is not None:
            ...
            for compt in compts:
                ...
                if compt.find(".") != -1 & compt.split(".")[0] in self.vars:
                    compt = compt.split(".")
...
if __name__ == "__main__":
    ...
    DR = DCRule('t1&t2&EQ(t1.HospitalName,t2.HospitalName)&EQ(t1.PhoneNumber,t2.PhoneNumber)&EQ(t1.HospitalOwner,t2.HospitalOwner)&IQ(t1.State,t2.State)', ['State', 'PhoneNumber', 'HospitalName', 'HospitalOwner'])