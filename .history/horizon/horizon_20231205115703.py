...
# dirty_path = "./data with dc_rules/hospital/noise/hospital-inner_outer_error-01.csv"
# rule_path = "./data with dc_rules/hospital/dc_rules-validate-fd-horizon.txt"
...
if True:
    if PERFECTED:
        out_path = "./Exp_result/horizon/" + task_name[:-1] +"/perfectED+EC_" + task_name + check_string(dirty_path) + ".txt"
        res_path = "./Repaired_res/horizon/" + task_name[:-1] +"/perfect_repaired_" + task_name + check_string(dirty_path) + ".csv"
        f = open(out_path, 'w')
        sys.stdout = f
    else:
        out_path = "./Exp_result/horizon/" + task_name[:-1] +"/onlyED_" + task_name + check_string(dirty_path) + ".txt"
        f = open(out_path, 'w')
        sys.stdout = f
        print(det_prec)
        print(det_rec)
        ...
        out_path = "./Exp_result/horizon/" + task_name[:-1] +"/oriED+EC_" + task_name + check_string(dirty_path) + ".txt"
        f = open(out_path, 'w')
        sys.stdout = f
        res_path = "./Repaired_res/horizon/" + task_name[:-1] +"/repaired_" + task_name + check_string(dirty_path) + ".csv"
    print(rep_precision)
    print(rep_recall)
    print(rep_f1)
    print(end_time-start_time)
