...
if __name__ == "__main__":
    ...
    # task_name = "tax1"
    # clean_path = "./data with dc_rules/tax/clean.csv"
    # dirty_path = "./data with dc_rules/tax/split_data/tax-dirty-original_error-0001k.csv"

    repaired_df = pd.read_csv(dirty_path)

    stra_path = "./data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name
    ...
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "./data with dc_rules/tax/split_data/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "./data with dc_rules/tax/split_data/raha-baran-results-" + task_name
    if os.path.exists(stra_path):
    ...
    out_path = "./Exp_result/raha_baran/" + task_name[:-1] + "/perfectED+EC_" + task_name + dirty_path[-25:-4] + ".txt"
    res_path = "./Repaired_res/raha_baran/" + task_name[:-1] + "/perfect_repaired_" + task_name + dirty_path[-25:-4] + ".csv"
