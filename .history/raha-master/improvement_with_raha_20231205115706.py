...
def process_method(method_name, task_name, i, j, error_type, detection_dictionary):
    ...
    clean_path = "./data with dc_rules/" + task_name + "/clean.csv"
    dirty_path = "./data with dc_rules/" + task_name + "/noise/" + task_name + error_type + str(j) + ".csv"
    ...
    try:
        ...
        improve_res_dir = "./Repaired_res/" + method_name + "/" + task_name + "/Raha_improved-" + task_name + str(i) + error_type + str(j) + ".csv"
...
def process_boostclean(method_name, task_name, i, j, error_type, detection_dictionary):
    ...
    clean_path = "./data with dc_rules/" + task_name + "/clean.csv"
    dirty_path = "./data with dc_rules/" + task_name + "/noise/" + task_name + error_type + str(j) + ".csv"
    # dirty_path = "./data with dc_rules/" + task_name + "/noise/" + task_name + '-dirty-original_error-' + str(j) + ".csv"
    method_res_dir = "./Repaired_res/" + method_name + "/" + task_name + "/repaired_" + task_name + str(i) + error_type + str(j) + ".csv"
        ...
        for task_name in task_names:
            ...
            for error_type in error_types:
                for j in error_rate:
                    ...
                    dirty_path = "./data with dc_rules/" + task_name + "/noise/" + task_name + error_type + str(j) + ".csv"
                    # dirty_path = "./data with dc_rules/" + task_name + "/split_data/" + task_name + '-dirty-original_error-' + str(j) + ".csv"
                    
                    clean_path = "./data with dc_rules/" + task_name + "/clean.csv"
                    # clean_path = "./data with dc_rules/" + task_name + "/split_data/tax-clean-clean_data_ori-0010k.csv"
                    dataset_dictionary = {
                        "name": dataset_name,
                        "path": dirty_path,
