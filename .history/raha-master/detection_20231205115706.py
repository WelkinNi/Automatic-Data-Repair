...
if __name__ == "__main__":
    ...
    # dirty_path = "./data with dc_rules/flights/noise/flights-inner_error-10.csv"
    ...
    res_path = "./Exp_result/raha_baran/" + task_name[:-1] + "/raha_only_" + task_name + dirty_path[-25:-4] + ".txt"
    dataset_dictionary = {
        "name": dataset_name,
        "path": dirty_path,
