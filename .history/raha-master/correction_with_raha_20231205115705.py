...
if __name__ == "__main__":
    ...
    stra_path = "./data with dc_rules/" + task_name[:-1] + "/noise/raha-baran-results-" + task_name + check_string(dirty_path)
    ...
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "./data with dc_rules/tax/split_data/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
        shutil.rmtree(stra_path)
    stra_path = "./data with dc_rules/tax/split_data/raha-baran-results-" + task_name + check_string(dirty_path)
    if os.path.exists(stra_path):
