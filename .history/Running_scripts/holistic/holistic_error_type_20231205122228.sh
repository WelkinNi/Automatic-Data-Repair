...
DIRTY_DATA="/data/nw/DC_ED/References/DATASET/data with dc_rules/hospital/noise/hospital-outer_error-"
CLEAN_DATA="/data/nw/DC_ED/References/DATASET/data with dc_rules/hospital/clean.csv"
RULE="/data/nw/DC_ED/References/DATASET/data with dc_rules/hospital/dc_rules_holoclean.txt"
TASK_NAME="hospital2"
...
do
    ...
    do        
        ...
        do
            DIRTY_DATA="/data/nw/DC_ED/References/DATASET/data with dc_rules/${TASK}/noise/${TASK}-inner_error-"
            ...
            DIRTY_DATA="/data/nw/DC_ED/References/DATASET/data with dc_rules/${TASK}/noise/${TASK}-outer_error-"
            DIRTY_DATA_PATH="${DIRTY_DATA}${NUM}.csv"
            /home/dell/anaconda3/envs/torch110/bin/python $PYTHON --task_name "$TASK_NAME" --rule_path "$RULE" --onlyed 0 --perfected 0 --dirty_path "$DIRTY_DATA_PATH" --clean_path "$CLEAN_DATA" &
        done
    done
