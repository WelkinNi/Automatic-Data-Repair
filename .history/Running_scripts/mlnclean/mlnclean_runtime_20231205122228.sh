...
do
    ...
    do        
        ...
        do                
            ...
            time /usr/bin/env /usr/lib/jvm/java-8-openjdk-amd64/bin/java -cp /tmp/cp_21mkjr659r871u00zg8emw14c.jar main.Test "${DIRTY_DATA_PATH}" "trainData.csv" "testData.csv" 1 0 > /data/nw/DC_ED/References_inner_and_outer/DATASET/aggre_results/output.txt 2>&1 || true
        done
    done
done