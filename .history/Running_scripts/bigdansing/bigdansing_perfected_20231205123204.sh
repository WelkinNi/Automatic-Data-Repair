...
do
    ...
    do        
        ...
        do
            ...
            /home/dell/anaconda3/envs/torch110/bin/python $PYTHON --task_name "$TASK_NAME" --rule_path "$RULE" --onlyed 0 --perfected 1 --dirty_path "$DIRTY_DATA_PATH" --clean_path "$CLEAN_DATA" &
