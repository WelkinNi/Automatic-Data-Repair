...
if __name__ == '__main__':
    ...
    # src_dirty = f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{name}/dirty.csv" 
    # tar_dirty = f"/data/nw/DC_ED/References_inner_and_outer/mlnclean/dataset/{name}/dataset/dirty.csv"
    src_clean = f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{name}/clean.csv" 
    tar_clean = f"/data/nw/DC_ED/References_inner_and_outer/mlnclean/dataset/{name}/dataset/clean.csv"
    src_dc = f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{name}/dc_rules_holoclean.txt" 
    ...
    if name == "tax":
        src_folder = f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{name}/runtime_noise" 
    else:
        src_folder = f"/data/nw/DC_ED/References_inner_and_outer/DATASET/data with dc_rules/{name}/noise" 
